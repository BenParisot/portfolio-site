        ...
        return (
            <section className="work">
                ...
                <ul>
                    ...
                    <li data-title="Tech Producer" data-company="Helios" data-description="Part scrum master and part release manager, I worked with clients, producers, designers, and developers to keep projects on schedule and deliver working app under strict deadlines." data-dates="July 2016 - Jan 2019" onClick={this.handleClick}>Tech Producer - Helios Interactive</li>
                </ul>
