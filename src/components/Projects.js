    ...
    return (
            <section className="projects-container">
                ...
                <section id="projects" className="projects">
                    ...
                    <Project title="Robot Haikut" image={robot} description="A Twitter bot that sends a randomly-generated haiku to those that ask for one." demo="Twitter Account" demoLink="https://twitter.com/RobotHaikubot" repo="Github Repo" repoLink="https://github.com/team-haikubot" color="#f26639" />
