    ...
    return (
        <>
            ...
            <section className="projects">
                <Project title="Mega Nap" image={meganap} description="A web app that lets front end developers generate API endpoints from any data set." demo="Live Demo" repo="Github Repo" color="#f26639" />
