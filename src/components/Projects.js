    ...
    return (
            <section className="projects-container">
                ...
                <section className="projects">
                    <Project title="Weather." image={weather} description="A serverless web app that takes a user-entered United States zip code and draws an interactive 12-hour temperature forecast line graph using the D3 visualization library." uses="React, D3, Styled Components, Firebase, Netlify" demo="Live Demo" demoLink="https://weatherdot.netlify.com/" repo="Github Repo" repoLink="https://github.com/BenParisot/sprinklr-takehome" color="#f04d4d" />
                    <Project title="Mega Nap" image={meganap} description="A full-stack web app that allows front end developers to input data and generate RESTful API endpoints." uses="Node.js, React/Redux, Styled Components, MongoDB, Heroku, Netlify" demo="Live Demo" demoLink="https://www.meganap.com/" repo="Github Repo" repoLink="https://github.com/grandpapi" color="#ed4b64" />
